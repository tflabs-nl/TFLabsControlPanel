...
export default function DatacenterRackSVG(props: IProps)
{
    ...
    return (
        <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M13 2.71484C13 3.75038 10.3137 4.58984 7 4.58984C3.68629 4.58984 1 3.75038 1 2.71484M13 2.71484C13 1.67931 10.3137 0.839844 7 0.839844C3.68629 0.839844 1 1.67931 1 2.71484M13 2.71484V12.5065M1 2.71484V12.356" stroke={ fill } strokeWidth="1.2" strokeLinejoin="round"/>
